...
export interface paths {
    "/airplanes": {
        ...
        get: operations["get/airplanes"];
        put?: never;
        post: operations["post/airplanes"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/airplanes/{id}": {
        ...
        get: operations["get/airplanes/{id}"];
        put: operations["put/airplanes/{id}"];
        post?: never;
        delete: operations["delete/airplanes/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        AirplaneListResponseDataItem: {
            id?: number;
            attributes?: components["schemas"]["Airplane"];
        };
        AirplaneListResponse: {
            data?: components["schemas"]["AirplaneListResponseDataItem"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
        ...
        AirplaneResponseDataObject: {
            id?: number;
            attributes?: components["schemas"]["Airplane"];
        };
        AirplaneResponse: {
            data?: components["schemas"]["AirplaneResponseDataObject"];
...
export interface operations {
    "get/airplanes": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AirplaneListResponse"];
                };
            };
    ...
    "post/airplanes": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AirplaneRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AirplaneResponse"];
                };
            };
            /** @description Bad Request */
            400: {
