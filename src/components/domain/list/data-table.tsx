...
import { DeleteAllDomains } from "../actions"

export function DataTable({data} : {data : Domain[]}) {
    ...
    <div className="w-full">
      <div className="flex flex-wrap items-center justify-between py-4">
        <Input
          ...
          className="max-w-sm border-2 border-gray-700"
        />
      ...
      <div className="rounded-md border-t border-gray-700">
        <Table>
          <TableHeader>
