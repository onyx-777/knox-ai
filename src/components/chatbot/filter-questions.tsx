...
import { useFilterQuestions } from "@/hooks/bot-training";
...
const FilterQuestions = ({ domainId }: Props) => {
  const { register, errors, onAddFilterQuestions, isQuestions, loading } =
    useFilterQuestions(domainId);

  return (
    <Card className="w-full mb-10 grid grid-cols-1 lg:grid-cols-2">
